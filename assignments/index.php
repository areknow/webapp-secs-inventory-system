...
<html>
    <head>
        ...
        <title>SECS Inventory | Room Assignments</title>
    ...
    <body>
		...
		<div class="nav">
			...
			<div class="sidemenu">
				...
				<a href="../assignments" class="selected">EC Room Assignments</a>
		...
		<div class="content">
			<table id="computers" class="display" cellspacing="0" width="100%">
				...
				<tbody>
				<?PHP $query = mysql_query("SELECT * FROM `EC Room Assignments`");
				while ($results = mysql_fetch_array($query)) { ?>
					<tr>
						<td><?PHP echo $results['Location'] ?></td>
						<td><?PHP echo $results['Responsible Party'] ?></td>
