...
<html>
    <head>
        ...
        <title>SECS Inventory | Post Move Lab Assignments</title>
    ...
    <body>
		...
		<div class="nav">
			...
			<div class="sidemenu">
				...
				<a href="../postmovelab" class="selected">Post Move Lab Assignments</a>
		...
		<div class="content">
			<table id="computers" class="display" cellspacing="0" width="100%">
				...
				<tbody>
				<?PHP $query = mysql_query("SELECT * FROM `Post Move Lab Assign`");
				while ($results = mysql_fetch_array($query)) { ?>
					<tr>
						<td><?PHP echo $results['Lab Location'] ?></td>
						<td><?PHP echo $results['Dept'] ?></td>
						<td><?PHP echo $results['Faculty'] ?></td>
						<td><?PHP echo $results['Lab Name'] ?></td>
					</tr>
				<?PHP } ?>
				</tbody>
			</table>
