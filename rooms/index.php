...
<html>
    <head>
        ...
        <title>SECS Inventory | Rooms</title>
    ...
    <body>
		...
		<div class="nav">
			...
			<div class="sidemenu">
				...
				<a href="../rooms" class="selected">EC Rooms</a>
		...
		<div class="content">
			<table id="computers" class="display" cellspacing="0" width="100%">
				...
				<tbody>
				<?PHP $query = mysql_query("SELECT * FROM `EC rooms`");
				while ($results = mysql_fetch_array($query)) { ?>
					<tr>
						<td><?PHP echo $results['Location'] ?></td>
						<td><?PHP echo $results['Room Name'] ?></td>
						<td><?PHP echo $results['Type'] ?></td>
						<td><?PHP echo $results['Software'] ?></td>
					</tr>
				<?PHP } ?>
				</tbody>
			</table>
