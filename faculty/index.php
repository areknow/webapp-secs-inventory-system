...
<html>
    <head>
        ...
        <title>SECS Inventory | Faculty</title>
    ...
    <body>
		...
		<div class="nav">
			...
			<div class="sidemenu">
				...
				<a href="../faculty" class="selected">Faculty</a>
			...
			<table id="computers" class="display" cellspacing="0" width="100%">
				...
				while ($results = mysql_fetch_array($query)) { ?>
					<tr>
						...
						<td><?PHP echo $results['Ph Ext'] ?></td>
						<td><?PHP echo $results['Office'] ?></td>
						<td><?PHP echo $results['E-mail'] ?></td>
						<td><?PHP echo $results['Dept'] ?></td>
						<td><?PHP echo $results['Present for Move?'] ?></td>
					</tr>
				<?PHP } ?>
				</tbody>
			</table>
