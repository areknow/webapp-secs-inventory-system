...
<html>
    <head>
        ...
        <title>SECS Inventory | Scanners</title>
    ...
    <body>
		...
		<div class="nav">
			...
			<div class="sidemenu">
				...
				<a href="../scanners" class="selected">Scanners</a>
		...
		<div class="content">
			<table id="computers" class="display" cellspacing="0" width="100%">
				...
				<tbody>
				<?PHP $query = mysql_query("SELECT * FROM `Computers` WHERE `Tag` = $tag");
				while ($results = mysql_fetch_array($query)) { ?>
					<tr>
						...
						<td><?PHP echo $results['Accessories'] ?></td>
						<td><?PHP echo $results['OS'] ?></td>
						<td><?PHP echo $results['Domain'] ?></td>
					</tr>
				<?PHP } ?>
				</tbody>
			</table>
